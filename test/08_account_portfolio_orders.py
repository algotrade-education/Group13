...
# # --- CẤU HÌNH CỨNG CHO GROUP 13 (BỎ QUA .ENV NẾU LỖI) ---
# # --- GÁN CỨNG GIÁ TRỊ ĐỂ TRÁNH LỖI ĐỌC .ENV ---
...
# --- Cập nhật lại cách gọi os.getenv ---
REST_BASE_URL  = os.getenv("PAPER_REST_BASE_URL")
USERNAME       = os.getenv("PAPER_USERNAME")
PASSWORD       = os.getenv("PAPER_PASSWORD")
SUB_ACCOUNT    = os.getenv("PAPER_SUB_ACCOUNT")
SOCKET_HOST    = os.getenv("PAPER_FIX_HOST")
SOCKET_PORT    = int(os.getenv("PAPER_FIX_PORT", 5001))
